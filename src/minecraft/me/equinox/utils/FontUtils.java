...
public class FontUtils extends MCInstance{
    ...
    public static void drawCenteredString(String text, int x, int y, int color) {
        drawString(text, (int) (x - getStringWidth(text) / 2), y, color);
    }
    ...
    public static void drawTotalCenteredString(String text, int x, int y, int color) {
        drawString(text, (x - getStringWidth(text) / 2), (y - fontRenderer.FONT_HEIGHT / 2), color);
    }

    public static void drawTotalCenteredStringWithShadow(String text, double x, double y, int color) {
        drawStringWithShadow(text, x - getStringWidth(text) / 2, y - fontRenderer.FONT_HEIGHT / 2F, color);
    }
}
